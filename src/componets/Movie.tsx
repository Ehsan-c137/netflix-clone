...
import CrossFadeImage from "./Utils/CrossFade";

const Movie = ({ item }: { item: IUser }) => {
   ...
   return (
      <div className="w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] h-[160px] inline-block cursor-pointer relative p-2">
         <CrossFadeImage
